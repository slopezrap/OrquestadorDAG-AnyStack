...
- Para incremento sobre producto existente: genera todos los slices necesarios para cubrir el incremento sin omitir baseline, reglas de dominio, pantallas, endpoints, tablas, integraciones ni journeys. Si necesitas construir foundation desde cero, usa `large-without-base` y planifica sus fases propias.
