...
- **Rol:** Use proactively before planning, implementation, debugging, deployment, or architecture decisions when external APIs, frameworks, package versions, CLIs, or Claude Code extension behavior might have changed. Official docs only.
